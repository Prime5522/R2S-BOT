...
class Database:
    ...
    def add_media(self, user_id, file_id):
    ...
    # 🟢 Confirmation Msgs
    def add_confirm_msg(self, user_id, msg_id):
        self.users.update_one(
            {"user_id": user_id},
    ...
    def get_confirm_msgs(self, user_id):
        user = self.users.find_one({"user_id": user_id})
        return user.get("confirm_msgs", []) if user else []

    def clear_confirm_msgs(self, user_id):
        self.users.update_one(
            {"user_id": user_id},
            {"$set": {"confirm_msgs": []}}
        )
    ...
    # 🟢 UserFiles
    def add_user_file(self, user_id, msg_id):
        self.users.update_one(
            {"user_id": user_id},
